...
|[`8-3-x1-endian.gdbnb`](./examples/8-3-x1-endian.gdbnb)|`x`でリトルエンディアンでの格納を確認する|
|[`8-3-x2-pointer.gdbnb`](./examples/8-3-x2-pointer.gdbnb)|`x`でポインタと実体の違いを確認する|
|[`8-3-x3-array.gdbnb`](./examples/8-3-x3-array.gdbnb)|`x`で配列の中身を確認する|
|[`8-3-x4-struct.gdbnb`](./examples/8-3-x4-struct.gdbnb)|`x`で構造体の中身を確認する|
|[`8-3-x5-instruction.gdbnb`](./examples/8-3-x5-instruction.gdbnb)|`x`で機械語命令の中身を確認する|
|[`8-3-x6-frame.gdbnb`](./examples/8-3-x-frame6.gdbnb)|`x`でスタックフレームのレイアウトを確認する|
|[`8-3-x7-buffer-overflow.gdbnb`](./examples/8-3-x7-buffer-overflow.gdbnb)|`x`でバッファオーバーフローを確認する|
