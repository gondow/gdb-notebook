...
|[`6-2-assignment.gdbnb`](./examples/6-2-assignment.gdbnb)|変数の値を変更して，無限ループから脱出する|
|[`6-3-jump.gdbnb`](./examples/6-3-jump.gdbnb)|`jump`を使って，無限ループから脱出する|
|[`6-4-return.gdbnb`](./examples/6-4-return.gdbnb)|`return`を使って，関数の返り値を変更する|
