...
|[`8-3-x-endian.gdbnb`](./examples/8-3-x-endian.gdbnb)|`x`でリトルエンディアンでの格納を確認する|
|[`8-3-x-pointer.gdbnb`](./examples/8-3-x-pointer.gdbnb)|`x`でポインタと実体の違いを確認する|
|[`8-3-x-array.gdbnb`](./examples/8-3-x-array.gdbnb)|`x`で配列の中身を確認する|
|[`8-3-x-struct.gdbnb`](./examples/8-3-x-struct.gdbnb)|`x`で構造体の中身を確認する|
|[`8-3-x-instruction.gdbnb`](./examples/8-3-x-instruction.gdbnb)|`x`で機械語命令の中身を確認する|
|[`8-3-x-frame.gdbnb`](./examples/8-3-x-frame.gdbnb)|`x`でスタックフレームのレイアウトを確認する|
|[`8-3-x-buffer-overflow.gdbnb`](./examples/8-3-x-buffer-overflow.gdbnb)|`x`でバッファオーバーフローを確認する|
